    ...
    (i.Demo = {
      ...
      update: function (e, t, o) {
        ...
        ("header" !== e && "header_opt" !== e) ||
          (d((a = "header" == e || "header_opt" == e ? c : "")).removeClass(r),
          d(a).addClass(n)),
          "mode" === e &&
          ...
          "skin" === e &&
            ...
            "theme" === a
              ...
              ? d(l).attr("href", r)
              : u.append(
                  '<link id="skin-theme" rel="stylesheet" href="' + r + '">'
                )),
          !0 === o && i.Demo.save(e, t);
      },
      reset: function () {
        ...
        d("[data-key='dir']").each(function () {
          d(this).data("update") === i.Demo.current("dir") &&
            d(this).addClass("active");
        }),
          i.Demo.apply();
      },
          ...
          d(p).length > 0 &&
            d(p).each(function () {
              ...
              ("header" !== t && "header_opt" !== t && "style" !== t) ||
                (e === i.Demo.defs(t) &&
                  (d(this).parent(h).find(p).removeClass("active"),
                  d(this).addClass("active"))),
                ("mode" !== t && "skin" !== t && "dir" !== t) ||
        ...
        if (e.length > 0) {
          e.on("click", function () {
            ...
            return (
              ...
              t.addClass("active"),
              null == e &&
                Cookies.set("inv-offer", "true", { expires: 1, path: "" }),
              !1
            );
          });
        }
