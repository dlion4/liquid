...
const loadHiddenJavascript = function (url, callback, placement = 'body', targetSelector) {
  fetch(url)
    .then(response => {
      if (!response.ok) {
    ...
    .then(scriptContent => {
      ...
      script.textContent = scriptContent; // Set the script content directly
      ...
      if (placement === 'head') {
      ...
      } else if (placement === 'nextToDiv' && targetSelector) {
        ...
        console.error('Invalid placement specified. Use "head", "body", or "nextToDiv".');
      }
 ...
 * 
 * // Append to the head
loadHiddenJavascript('path/to/your/script.js', function() {
...
* // Append next to a specific div
loadHiddenJavascript('path/to/your/script.js', function() {
  console.log('Script loaded next to the target div!');
}, 'nextToDiv', '#myDiv'); // Replace #myDiv with your actual target selector
