    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='profile_address', to='users.profile')),
            ],
        ),
        migrations.CreateModel(
            name='Document',
            fields=[
                ...
                ('document', models.ImageField(upload_to=amiribd.users.models.user_directory_path)),
                ('profile', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='profile_document', to='users.profile')),
            ],
        ),
    ]
